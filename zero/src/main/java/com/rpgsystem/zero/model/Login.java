...
public class Login {
    ...
    private void visualizarFicha(Usuario usuario) {
        ...
        // Referencia o parâmetro para evitar aviso de variável não utilizada
        System.out.println("Abrindo ficha para: " + usuario);
    }

    private void abrirInventario(Usuario usuario) {
        // Referencia o parâmetro para evitar aviso de variável não utilizada
        System.out.println("Abrindo inventário para: " + usuario);
    }

    private void abrirHabilidades(Usuario usuario) {

        // Referencia o parâmetro para evitar aviso de variável não utilizada
        System.out.println("Abrindo habilidades para: " + usuario);
    }

    private void abrirLoja(Usuario usuario) {

        System.out.println("Abrindo loja para: " + usuario);
    }

    private void alterarDados(Usuario usuario) {

        System.out.println("Alterando dados para: " + usuario);
    }
